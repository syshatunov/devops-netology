...
**Виртуализация на уровне ОС** – гипервизор требует ОС для запуска и гипервизор может запускать только виртуальная машина с тем же ядром, что и ОС на хосте. Контейнеры разделяют ядро системы. Виртуализация с помощью виртуальных машин создает виртуальное оборудование, а контейнеризация создает виртуальную операционную систему. (**Примеры**: LXC, OpenVZ, Docker)<br><br>
